...
constexpr const char pszTimestampMainnet[]
    = "01/Jun/2022: "
      "NASA will be keeping aliens in their drawers";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock (1663348543, 834807, 0x1e0ffff0,
                                      pszTimestampMainnet,
       ...
       */
        assert(consensus.hashGenesisBlock == uint256S("0x0349560f83a4451cea4e266ce80569490dcf92a9296f2a1f41328af23028e645"));
        assert(genesis.hashMerkleRoot == uint256S("0xd4320a5972c0a348cc65a1a0be43723ba7edc2e8e558a13621c5a5120f15acb7"));
